...
$(document).ready(function(){
 ...
 $(function(){
   ...
   $('.asd').mouseenter(function(){
      $(this).children('.asdf').stop().fadeIn();
   });
   $('.asd').mouseleave(function(){
      $(this).children('.asdf').stop().fadeOut();
   });
});
...
//로그인 버튼 포커스 이벤트
$(function(){
   $("#color1").css({"opacity":"0","transition":"ease 1s"});
   $("#color2").css({"opacity":"0","transition":"ease 1s"});
   $("input").click(function(){
      $(this).eq(0).siblings("#color1").css({"opacity":"1","transition":"ease 0.5s"});
   });
   $("input").focusout(function(){
      $(this).eq(0).siblings("#color1").css({"opacity":"0","transition":"ease 1s"});
   });
});
$(function(){
   $("input").click(function(){
      $(this).eq(0).siblings("#color2").css({"opacity":"1","transition":"ease 0.5s"});
   });
   $("input").focusout(function(){
      $(this).eq(0).siblings("#color2").css({"opacity":"0","transition":"ease 1s"});
   });
});
...
//로그인창 투명 비투명 버튼
$(function(){
   $("#delite1").css({"opacity":"0","transition":"ease 1s"});
   $("#delite2").css({"opacity":"0","transition":"ease 1s"});
   $("input").click(function(){
      $(this).eq(0).siblings("#delite1").css({"opacity":"1","transition":"ease 0.5s"});
   });
   $("input").focusout(function(){
      $(this).eq(0).siblings("#delite1").css({"opacity":"0.3","transition":"ease 1s"});
   });
   $("input").click(function(){
      $(this).eq(0).siblings("#delite2").css({"opacity":"1","transition":"ease 0.5s"});
   });
   $("input").focusout(function(){
      $(this).eq(0).siblings("#delite2").css({"opacity":"0.3","transition":"ease 1s"});
   });
})